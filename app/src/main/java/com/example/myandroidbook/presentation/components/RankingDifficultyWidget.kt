...
import com.example.myandroidbook.ui.theme.startColor

@Composable
fun RankingDifficultyWidget(
    modifier: Modifier,
    ranking: Double,
    ...
    //
    val result = calculateStars(rating = ranking)
...
fun PreviewStar() {
    RankingDifficultyWidget(modifier = Modifier, ranking = 3.5)
}
